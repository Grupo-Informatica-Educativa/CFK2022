...
def grafica_d_inicial():
    data = read_data("genero_2021_d_i")
    return generador_grafica(data)


def grafica_d_avanzado():
    data = read_data("genero_2021_d_a")
    return generador_grafica(data)

def grafica_sd_inicial():
    data = read_data("genero_2021_sd_i")
    return generador_grafica(data,False)

    
def grafica_sd_avanzado():
    data = read_data("genero_2021_sd_a")
    return generador_grafica(data,False)
...
opts_map = {
    "Sí":{
        ...
        "Avanzado": grafica_d_avanzado
    },
    "No":{
        "Inicial": grafica_sd_inicial,
        "Avanzado": grafica_sd_avanzado
    },
}
...
def app():
    ...
    test = st.selectbox("Tipo", ["Inicial","Avanzado"])
