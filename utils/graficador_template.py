...
'''
Lo importante al momento de usar archivos es dividirlos en dos, uno de caracterización y otro con
las respuestas
...
columna_unica = 'N registro' # Caracterización y los valores deben ser unicos (la mayoria)
...
if nombre_archivo:
    datos = fetch_data(nombre_archivo)
    ...
    '''
    nombres_preguntas: sirve para hacerle saber cuales son las preguntas
    que tienen subpreguntas, por ejemplo:
    ...
    "Numero de la pregunta" : "La columna de la pregunta"

    '''

    ejex, color, columna, fila = filtros_def

    # De aquí para abajo puro copia y pega xd
